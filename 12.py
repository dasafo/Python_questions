...
# in computer graphics. It is used for drawing lines.  Given the coordinate of 
# two points A(x1, y1) and B(x2, y2). The task is to find all the intermediate 
# points required for drawing line AB on the computer screen of pixels.
...
# 3. The equation of the straight line is y = m*x+c. So the next thing we need
# to find is the intercept c
